...
function checkLegacy() {
	if (typeof livestats == "undefined") {
		...
		if (si == "default") { si = "0"; }
		var i = new Image(1,1); i.src="http://stats.bbc.co.uk/o.gif?~RS~s~RS~ws~RS~t~RS~HighWeb_Legacy~RS~i~RS~" + si + "~RS~p~RS~0~RS~a~RS~Spanish~RS~u~RS~" + document.location + "~RS~r~RS~" + document.referrer + "~RS~q~RS~-~RS~z~RS~0~RS~";
	}
}
...
if (navigator.appName == 'Microsoft Internet Explorer')
  {
	...
	if (si.length == 7) {
		...
		if (documentURL.match(/http:\/\/news/)) {
				var i = new Image(1,1); i.src="http://stats.bbc.co.uk/o.gif?~RS~s~RS~ws~RS~t~RS~" + ty + "~RS~i~RS~" + si + "~RS~p~RS~0~RS~a~RS~Spanish~RS~u~RS~" + document.location + "~RS~r~RS~" + document.location + "~RS~q~RS~-~RS~z~RS~0~RS~";
