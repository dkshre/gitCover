...
/*
Version: 3.6.6
Includes new tracking servers
 */
 
	//Identify Language service name
 	if ("undefined" != typeof ws &&
		"undefined" != typeof ws.siteCatalyst ) {
		var origws = ws.siteCatalyst.service;
 		//Replace service names if they contain '_1024' or '_gel'
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_1024")) ? ws.siteCatalyst.service.replace("_1024","") : ws.siteCatalyst.service; 
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_gel")) ? ws.siteCatalyst.service.replace("_gel","") : ws.siteCatalyst.service; 
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_simp")) ? ws.siteCatalyst.service.replace("_simp","") : ws.siteCatalyst.service; 
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_trad")) ? ws.siteCatalyst.service.replace("_trad","") : ws.siteCatalyst.service; 
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_simplified")) ? ws.siteCatalyst.service.replace("_simplified","") : ws.siteCatalyst.service; 
		ws.siteCatalyst.service = (ws.siteCatalyst.service.match("_traditional")) ? ws.siteCatalyst.service.replace("_traditional","") : ws.siteCatalyst.service; 
		
		if (ws.siteCatalyst.service == 'arabic_1024') ws.siteCatalyst.service = 'arabic';
		if (ws.siteCatalyst.service == 'china') ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.service == 'cojo_gel') ws.siteCatalyst.service = 'other';
		if (ws.siteCatalyst.service.match('cojo')) ws.siteCatalyst.service = 'other';		
		if (ws.siteCatalyst.service == 'english') ws.siteCatalyst.service = 'worldservice';		
		if (ws.siteCatalyst.service == 'french') ws.siteCatalyst.service = 'afrique';
		if (ws.siteCatalyst.service == 'gahuza') ws.siteCatalyst.service = 'greatlakes';
		if (ws.siteCatalyst.service == 'great_lakes') ws.siteCatalyst.service = 'greatlakes';		
		if (ws.siteCatalyst.service == 'indonesia') ws.siteCatalyst.service = 'indonesian';
		if (ws.siteCatalyst.service == 'myanmar') ws.siteCatalyst.service = 'burmese';
		if (ws.siteCatalyst.service == 'russian_1024') ws.siteCatalyst.service = 'russian';		
		if (ws.siteCatalyst.service == 'russian_liveplanet') ws.siteCatalyst.service = 'russian';		
		if (ws.siteCatalyst.service == 'russiannet') ws.siteCatalyst.service = 'russian';
		if (ws.siteCatalyst.service == 'tajik') ws.siteCatalyst.service = 'persian';		
		if (ws.siteCatalyst.service == 'turkce') ws.siteCatalyst.service = 'turkish';
		if (ws.siteCatalyst.service == 'ukchina_simp') ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.service == 'ukchina_simplified') ws.siteCatalyst.service = 'ukchina';		
		if (ws.siteCatalyst.uri.match('ukchina/simp')) ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.service == 'ukchina_trad') ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.service == 'ukchina_traditional') ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.uri.match('ukchina/trad')) ws.siteCatalyst.service = 'ukchina';
		if (ws.siteCatalyst.uri.match('worldservice_1024')) ws.siteCatalyst.service = 'worldservice';
		if (ws.siteCatalyst.service == 'zhongwen/trad') ws.siteCatalyst.service = 'chinese';
		if (ws.siteCatalyst.uri.match('zhongwen/trad')) ws.siteCatalyst.service = 'chinese';
		if (ws.siteCatalyst.service == 'zhongwen/simp') ws.siteCatalyst.service = 'chinese';
		if (ws.siteCatalyst.uri.match('zhongwen/simp')) ws.siteCatalyst.service = 'chinese';
		if (ws.siteCatalyst.service == 'zhongwen') ws.siteCatalyst.service = 'chinese';		

		//Set Report Suites for Learning English sub-sites		
		if (ws.siteCatalyst.uri.match('ukchina/simp/elt')) ws.siteCatalyst.service = 'ukchina,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('hindi/learningenglish')) ws.siteCatalyst.service = 'hindi,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('persian/learningenglish')) ws.siteCatalyst.service = 'persian,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('turkce/ingilizce_dersleri')) ws.siteCatalyst.service = 'turkish,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('ukrainian/learning_english')) ws.siteCatalyst.service = 'ukrainian,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('uzbek/learningenglish')) ws.siteCatalyst.service = 'uzbek,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('burmese/news/learning_talking_sports.shtml')) ws.siteCatalyst.service = 'burmese,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('french/highlights/cluster/2008/03/080321_english_by_radio.shtml')) ws.siteCatalyst.service = 'afrique,bbclearningenglish';		
		if (ws.siteCatalyst.uri.match('albanian/learningenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('czech/learningenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('polish/englishgrammar')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('polish/everydayenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('polish/businessenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('serbian/learningenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';
		if (ws.siteCatalyst.uri.match('thai/learningenglish')) ws.siteCatalyst.service = 'wsother,bbclearningenglish';		
		
		//Set the correct name of the language reporting suite
		var suiteServiceName = ws.siteCatalyst.service;
		if (suiteServiceName == "portuguese") suiteServiceName = "portuguesebrazil";
		if (suiteServiceName == "portugueseafrica") suiteServiceName = "wsother";
		if (suiteServiceName == "albanian") suiteServiceName = "wsother";
		if (suiteServiceName == "caribbean") suiteServiceName = "wsother";
		if (suiteServiceName == "macedonian") suiteServiceName = "wsother";
		if (suiteServiceName == "nazer") suiteServiceName = "wsother";
		if (suiteServiceName == "serbian") suiteServiceName = "wsother";		
		}
		
var s_account = "bbcwglobalprod,bbc"+suiteServiceName;
...
/* Dynamically set the number of domain periods */
var dmn = document.domain; 
var search = /\./g; 
for(var xyz=0; search.exec(dmn); ++xyz); 
s.cookieDomainPeriods=xyz; 
s.fpCookieDomainPeriods=s.cookieDomainPeriods; 
...
function s_doPlugins(s) {
    ...
    if (document.getElementsByName) {
        ...
        s.hier1 = "worldservice|"+document.title.replace(/ - /g, '|');
	...
	if ("undefined" != typeof ws &&	"undefined" != typeof ws.siteCatalyst ) {
	
		// ws.siteCatalyst.storyId contains the Topcat ID number of page
		//s.prop4 = ws.siteCatalyst.storyId;
		
		var sPath = window.location.pathname;
		var sPage = sPath.substring(sPath.lastIndexOf('/') + 1);
		s.prop4 = "ws::"+ws.siteCatalyst.storyId;
		
		//Normalise documentType names
		if (ws.siteCatalyst.documentType == 'wsemp') ws.siteCatalyst.documentType = 'av_instance';		

		try {
		    if (glow) {
				var docType = ws.siteCatalyst.documentType.toLowerCase();
				if (glow.dom.get('.index').length) { docType = "INDEX"; }
				else if (glow.dom.get('.story .emp-f-video').length) { docType = "STORY-VIDEO"; }
				else if (glow.dom.get('.story .emp-f-audio').length) { docType = "STORY-AUDIO"; }
				else if (glow.dom.get('.story').length) { docType = "STORY"; }				
				else if (glow.dom.get('.av-instance .emp-f-audio').length) { docType = "AUDIO"; }				
				else if (glow.dom.get('.av-instance .emp-f-video').length) { docType = "VIDEO"; }
				else if (glow.dom.get('.cluster').length) { docType = "CLUSTER"; }				
				else if (window.location.hostname == 'newsforums.bbc.co.uk') { docType = "BLOGS & FORUMS"; }
				else if (window.location.pathname.match('/programmes/')) { docType = "PROGRAMME PAGE"; }
				else if (window.location.pathname.match('/blogs/')) { docType = "BLOGS & FORUMS"; }
				//console.log(docType);
				s.prop5 = docType;
			}
		} catch(e) {
			s.prop5 = ws.siteCatalyst.documentType.toLowerCase();
		}
		
		//s.prop5 = ws.siteCatalyst.documentType.toLowerCase();

		
		s.prop6 = "ws::"+ws.siteCatalyst.section;
		s.prop15 = s.eVar15 = ws.siteCatalyst.uri;
		
		s.eVar59 = getCookie("s_vi");
		
	
		//Set Language service name
		s.prop45 = origws;	
		
		//Set the Syndication Partner to BBC for partner page reporting
		s.prop25 = 'BBC';
		
		//Arabic FontTest variable
		s.prop28 = ws.siteCatalyst.fontTest;
		
		//Pathing
		s.prop7 = "ws::"+ ws.siteCatalyst.service + '>' + ws.siteCatalyst.section;
		
		s.prop34 = "ws::"+ s.prop45 + "_" + s.prop5;
		s.prop5 = "ws::" + s.prop5;
		
		s.prop55 = s.eVar55 = "worldservice";
		
	}
	
	//Measure the Percentage of Page Viewed
	s.prop29 = s.getPercentPageViewed();

	//s.prop30 = s.getPreviousValue(s.pageName,"s_pv");
...
/*********************** PLUGINS SECTION ****************************/
    ...
    function evaluateUrl(siteUrl) {
        ...
        //remove protocole in url
        newUrl = url.replace(/^(http|https):\/\//g, "");
        //document.writeln("Remove domain new = " + newUrl + br);

        //find content id in url
        var reContentId = new RegExp("[0-9][0-9][0-9][0-9][0-9][0-9][0-9]", "g");
        contentIdMatch = reContentId.test(url)
        //document.writeln("Content Id match = " + contentIdMatch + br);

        //split the url
        hArray = newUrl.split("\/");
        hLength = hArray.length;

        var reMatchSiteSection;
        var siteSectionMatch;

        if (hLength >= 2) {

            siteSection = hArray[1];
            //document.writeln("siteSection = " + siteSection + br);

            switch (siteSection) {
                case 'blogs': blogs(); break;
                //default:document.writeln("no siteSection found" + br);break; 
            }
        }
        if ("undefined" != typeof h1)
        {
            s.prop6 = h1;
            s.pageName = h1;
        }
        ...
        {
            s.prop45 = h2;			
            s.pageName = s.pageName + ":" + h2;
        }
        if ("undefined" != typeof h3)
        {
            s.prop8 = h3;
            s.pageName = s.pageName + ":" + h3;
        }
        if ("undefined" != typeof h4)
        {
            s.prop9 = h4;
            s.pageName = s.pageName + ":" + h4;    
        }        
    }
	...
	function k() {
			...
			if (hLength >= 4) {
				h3 = hArray[1] + ">" + hArray[2] + ">" + hArray[3];
			}

			if (hLength >= 5) {
				h4 = hArray[1] + ">" + hArray[2] + ">" + hArray[3] + ">" + hArray[4];
			}	
	}
...
s.Media.trackVars="eVar21,eVar22,eVar23,eVar31,eVar55,events,prop21,prop22,prop23";
...
s.Media.monitor = function (s, obj) {//Use this code with either JavaScript or Flash.
	...
	if(1==1){ //just so i can turn it on and off as required.
		...
		switch(obj.mediaEvent){
			case "movieStart":  //Executes when the player initialises.
				s.setMediaProperties(obj);
				s.Media.trackEvents = "event3,event6";
			...
			case "contentStart":  //Executes when the content starts.
				...
				//delete obj;
			break;
			case "contentEnd":  //Executes when the player initialises.
				s.setMediaProperties(obj);
				s.Media.trackEvents = "event7,event8";
				s.events = "event7,event8";
				//alert(var_dump(obj));
				//console.log(var_dump(obj));
				s.Media.stop(obj.mediaName);
				s.Media.track(obj.mediaName);
				
			break;
			case "movieEnd":  //Executes when the player initialises.
				s.setMediaProperties(obj);
...
s.setMediaProperties = function(obj){
	
	obj.mediaName = obj.mediaName.replace("ws::", "");
	obj.mediaName = "ws::"+obj.mediaName;
	
	obj.avType = obj.avType.replace("ws::", "");
	obj.avType = "ws::"+obj.avType;
	
	obj.mediaId = obj.mediaId.replace("ws::", "");
	obj.mediaId = "ws::"+obj.mediaId;
...
function startMovie(obj) {
	if(typeof obj.mediaOffset == "function") {
					obj.mediaOffset = 0;
	}
	//alert(var_dump(obj));
   obj.mediaEvent = "movieStart";
...
function playMovie(obj) {
	//alert('in here');
	if(obj.mediaLength > 0){
		obj.mediaEvent = "contentStart";
		s.Media.monitor(s, obj);
	}
...
function stopMovie(obj) {
	...
	window.setTimeout(function(){asynchStopMovie(obj);},1);
	
 }

function asynchStopMovie(obj){
   //alert('asynch stop movie');
   delete obj.mediaEvent;
   obj.mediaEvent = "contentEnd";
...
function endMovie(obj) {
	window.setTimeout(function(){asynchEndMovie(obj);},1);
 
}
function asynchEndMovie(obj) {
	//alert('asynch end movie');
	if(typeof obj.mediaOffset == "function") {
					obj.mediaOffset = 0;
	}
   delete obj.mediaEvent;
...
s.visitorMigrationKey="4F9A739C"
s.visitorMigrationServer="bbc.112.2o7.net"
s.visitorMigrationServerSecure="bbc.112.2o7.net"
...
+"nType=ct;s.homepage=hp;s.plugins=modifyPluginString();s.td=1}if(vo){s.vob(vb);s.voa(vo)}if((vo&&vo._t)||!s.m_m('d')){if(s.usePlugins)s.doPlugins(s);var l=s.wd.location,r=tfs.document.referrer;if(!s.pageURL)s.pageURL="
